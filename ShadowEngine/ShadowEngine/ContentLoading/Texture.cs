...
namespace ShadowEngine.ContentLoading
{
    ...
    public static class Texture
    {
        ...
        const int GL_EXT_TEXTURE_RECTANGLE = 0x84F5;
        ...
        /// </summary>
        static public TexttureInfo LoadSingleTexture(string path)
        {
            ...
            return new TexttureInfo();
        }

        /// <summary>
        /// This method performs a low level load of a texture
        /// </summary>
        static TexttureInfo LoadTexture(string path)
        {
            int[] texture = new int[1];

            //Gl.glEnable(GL_EXT_TEXTURE_RECTANGLE);
        ...
        /// </summary>
        static TexttureInfo LoadTGA(string filename)
        {
